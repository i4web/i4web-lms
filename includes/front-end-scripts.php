...
function i4_lms_scripts() {
    ...
    wp_enqueue_script('i4-manage-patients-js', I4_PLUGIN_URL . 'assets/js/manage-patients.js', array('jquery', 'jquery-ui-sortable', 'confirm-with-reveal', 'touchpunch'), '0.0.1', true);
    wp_enqueue_script('touchpunch', I4_PLUGIN_URL . 'assets/js/jquery.ui.touch-punch.min.js', array('jquery', 'jquery-ui'), '0.0.1', true);
